...
module EdmentumClient
  class EdApiModelsExactPathClassLearner
    ...
    def valid?
      ...
      gender_validator = EnumAttributeValidator.new('Integer', ['0', '1', '-1'])
    ...
    def gender=(gender)
      validator = EnumAttributeValidator.new('Integer', ['0', '1', '-1'])
    ...
    def hash
      [user_id, first_name, last_name, grade, gender, birth_date, is_active].hash
    end
