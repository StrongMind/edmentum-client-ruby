...
module EdmentumClient
  class EdApiModelsResourceNode
    ...
    def self.swagger_types
      {
        ...
        :'children' => :'Array<EdApiModelsResourceNode>'
      }
    end
    ...
    def hash
      [resource_name, resource_node_id, resource_version, resource_type, has_children, children].hash
    end
